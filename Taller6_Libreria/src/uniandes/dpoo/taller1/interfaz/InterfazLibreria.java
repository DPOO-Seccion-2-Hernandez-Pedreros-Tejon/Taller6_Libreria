	...
	public void cargarArchivos(File archivo_categorias, File archivo_libros)
	{
		try
		{
			...
			try
			{
				...
				{
					throw new Exception("Hubo que crear nuevas categor�as.");
				}
			}
			catch (Exception e)
			{
				...
				{
					error += "Se cre� la nueva categor�a";
				}
				else
				{
					error += "Se crearon las nuevas categor�as";
				}
				...
				JOptionPane.showMessageDialog(this, error, "Hubo que crear nuevas categor�as",
